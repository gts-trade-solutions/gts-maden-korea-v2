...
export const S3_MEDIA_BUCKET = process.env.S3_MEDIA_BUCKET || "madenkorea-media";
...
// Server-side byte upload (used by /api/uploads/social).
...
// when a route needs to persist a full URL (e.g. the social uploader).
