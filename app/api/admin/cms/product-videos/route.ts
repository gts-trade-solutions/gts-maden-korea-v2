...
// Admin product-video list read, MySQL-authoritative (Prisma). Mirrors
// the old browser Supabase `select(...)` in
// app/admin/cms/product-video/page.tsx: filter page_scope (?scope=,
...
export async function GET(req: Request) {
  ...
  try {
    const videos = await prisma.home_product_videos.findMany({
